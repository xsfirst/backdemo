    ...
    handleImageLoad:function(){
        ...
        function countdown(){
            ...
            setTimeout(function(){
                ...
                self.addNum =Math.ceil(Math.random()*6);
        ...
        function crazyMode(){
            ...
            //25秒crazymode
            if(self.crazytime>25*self.fps && snakeList.length<=15){
                self.crazytime = 0;
...
//                }
            ...
            for(var k=0;k<self.snake.frog.length;k++){
                if(self.x == self.snake.frog[k].obj.x && self.y == self.snake.frog[k].obj.y){
                    eatFrog(k);
                }
            }
        ...
        function rand_frog(){
            ...
            if(self.snake.frog.length>1){
                for(var j=0;j<self.snake.frog.length;j++){
                    if(self.snake.frog[j].obj.x == crandx && self.snake.frog[j].obj.y == crandy){
                        isok = false;
                    }
                }
            }
...
//                }
                ...
                for(var k=0;k<self.snake.frog.length;k++){
                    if(self.snake.frog[k].obj.x == crandx && self.snake.frog[k].obj.y == crandy){
                        isok = false;
                    }
                }
            }
